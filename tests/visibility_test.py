...
for edge in vis_set:
	(node1,node2) = edge
	(xloc1, yloc1) = map0.graph.node[node1]['pos']
	(xloc2, yloc2) = map0.graph.node[node2]['pos']
	x1 = int(((xloc1 - map0.origin[0])/map0.img_res))
	y1 = int(((-yloc1 + map0.origin[1])/map0.img_res)+map0.imgheight)
	x2 = int(((xloc2 - map0.origin[0])/map0.img_res))
	y2 = int(((-yloc2 + map0.origin[1])/map0.img_res)+map0.imgheight)
